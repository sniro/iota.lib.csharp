# Converter.MAX_TRIT_VALUE Field
 

\[Missing <summary> documentation for "F:Iota.Lib.CSharp.Api.Utils.Converter.MAX_TRIT_VALUE"\]
...
**C#**<br />
``` C#
public static readonly int MAX_TRIT_VALUE
```
