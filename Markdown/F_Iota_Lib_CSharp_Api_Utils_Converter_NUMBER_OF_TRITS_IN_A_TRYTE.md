# Converter.NUMBER_OF_TRITS_IN_A_TRYTE Field
 

\[Missing <summary> documentation for "F:Iota.Lib.CSharp.Api.Utils.Converter.NUMBER_OF_TRITS_IN_A_TRYTE"\]
...
**C#**<br />
``` C#
public static readonly int NUMBER_OF_TRITS_IN_A_TRYTE
```
